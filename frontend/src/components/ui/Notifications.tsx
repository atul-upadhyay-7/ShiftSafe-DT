    ...
    >
      <div className="glass-card p-4 border-l-4 border-l-emerald-500 shadow-2xl">
        <div className="flex items-start gap-3">
          <div className="text-2xl flex-shrink-0 mt-0.5">{data.emoji}</div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-bold text-primary-500 uppercase tracking-widest">ShiftSafe Alert</span>
              <span className="text-[10px] text-gray-500">Just now</span>
            </div>
            <p className="text-sm font-bold text-slate-900 mb-1">{data.title}</p>
            <p className="text-xs text-gray-600 mb-2">{data.subtitle}</p>
            <div className="flex items-center justify-between pt-2 border-t border-slate-100">
              <span className="text-xs text-gray-500">Auto-initiated payout</span>
              <span className="text-sm font-bold text-emerald-500">₹{data.amount}</span>
            </div>
          </div>
        </div>
      </div>
